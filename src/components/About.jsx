      ...
      <div style={{ maxWidth: 1400, margin: '0 auto' }}>
        ...
        <FadeIn delay={0.15}>
          <div style={{
            ...
            <StatBlock value={100} suffix="+" label="Projects Delivered" accent={accent} headingFont={headingFont} bodyFont={bodyFont} />
            <StatBlock value={98} suffix="%" label="Client Retention" accent={accent} headingFont={headingFont} bodyFont={bodyFont} />
            <StatBlock value={250} suffix="M+" label="Revenue Generated" accent={accent} headingFont={headingFont} bodyFont={bodyFont} />
            <StatBlock value={24} suffix="/7" label="Support & Strategy" accent={accent} headingFont={headingFont} bodyFont={bodyFont} isLast />
          </div>
        </FadeIn>
      </div>
    </section>
